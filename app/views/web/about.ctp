    ...
    <div id="wrapper">
        ...
        <div class="content">
            ...
            <section class="parallax-section" data-scrollax-parent="true" id="sec1">
                <div class="bg par-elem "  data-bg="<?php echo $html->url($theme)?>themes/enxona/images/bg/24.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="video-box fl-wrap">
                                    <img src="<?php echo $html->url($theme)?>themes/enxona/images/all/16.jpg" alt="">
                    ...
                    <div class="team-holder section-team fl-wrap">
                        ...
                        <div class="team-box">
                            <div class="team-photo">
                                <img src="<?php echo $html->url($theme)?>themes/enxona/images/team/1.jpg" alt="" class="respimg">
                            </div>
                            <div class="team-info">
                        ...
                        <div class="team-box">
                            <div class="team-photo">
                                <img src="<?php echo $html->url($theme)?>themes/enxona/images/team/2.jpg" alt="" class="respimg">
                            </div>
                            <div class="team-info">
                        ...
                        <div class="team-box">
                            <div class="team-photo">
                                <img src="<?php echo $html->url($theme)?>themes/enxona/images/team/3.jpg" alt="" class="respimg">
                            </div>
                            <div class="team-info">
            ...
            <section class="parallax-section" data-scrollax-parent="true">
                ...
                <div class="container">
                    <div class="intro-item fl-wrap">
                        ...
                        <a class="trs-btn" href="/web/contacts">Get in Touch + </a>
                    </div>
                </div>
            </section>
            <section id="sec5">
