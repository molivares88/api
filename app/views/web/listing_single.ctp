        ...
        <div class="list-single-carousel-wrap fl-wrap" id="sec1">
            <div class="fw-carousel fl-wrap full-height lightgallery">
                ...
                <div class="slick-slide-item">
                    <div class="box-item">
                        <img  src="<?php echo $html->url($theme)?>images/all/single/9.jpg"   alt="">
                        <a href="<?php echo $html->url($theme)?>images/all/single/9.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                    </div>
                </div>
                ...
                <div class="slick-slide-item">
                    <div class="box-item">
                        <img  src="<?php echo $html->url($theme)?>images/all/single/8.jpg"   alt="">
                        <a href="<?php echo $html->url($theme)?>images/all/single/8.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                    </div>
                </div>
                <!-- slick-slide-item end -->
                <!-- slick-slide-item -->
                <div class="slick-slide-item">
                    <div class="box-item">
                        <img  src="<?php echo $html->url($theme)?>images/all/single/7.jpg"   alt="">
                        <a href="<?php echo $html->url($theme)?>images/all/single/7.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                    </div>
                </div>
                <!-- slick-slide-item end -->
                <!-- slick-slide-item -->
                <div class="slick-slide-item">
                    <div class="box-item">
                        <img  src="<?php echo $html->url($theme)?>images/all/single/10.jpg"   alt="">
                        <a href="<?php echo $html->url($theme)?>images/all/single/10.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                    </div>
                </div>
                <!-- slick-slide-item end -->
                <!-- slick-slide-item -->
                <div class="slick-slide-item">
                    <div class="box-item">
                        <img  src="<?php echo $html->url($theme)?>images/all/single/11.jpg"   alt="">
                        <a href="<?php echo $html->url($theme)?>images/all/single/11.jpg" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                    </div>
                </div>
                <!-- slick-slide-item end -->
            </div>
                                ...
                                <div class="reviews-comments-wrap">
                                    ...
                                    <div class="reviews-comments-item">
                                        <div class="review-comments-avatar">
                                            <img src="<?php echo $html->url($theme)?>images/avatar/1.jpg" alt="">
                                        </div>
                                    ...
                                    <div class="reviews-comments-item">
                                        <div class="review-comments-avatar">
                                            <img src="<?php echo $html->url($theme)?>images/avatar/2.jpg" alt="">
                                        </div>
                                        <div class="reviews-comments-item-text">
                                    ...
                                    <div class="reviews-comments-item">
                                        <div class="review-comments-avatar">
                                            <img src="<?php echo $html->url($theme)?>images/avatar/3.jpg" alt="">
                                        </div>
                                        <div class="reviews-comments-item-text">
                            ...
                            <div class="box-widget-item fl-wrap">
                                ...
                                <div class="box-widget list-author-widget">
                                    <div class="list-author-widget-header shapes-bg-small  color-bg fl-wrap">
                                        ...
                                        <img src="<?php echo $html->url($theme)?>images/avatar/4.jpg" alt="">
                                    </div>
                                    <div class="box-widget-content">
                            ...
                            <div class="box-widget-item fl-wrap">
                                ...
                                <div class="box-widget widget-posts">
                                    <div class="box-widget-content">
                                        <ul>
                                            <li class="clearfix">
                                                <a href="#"  class="widget-posts-img"><img src="<?php echo $html->url($theme)?>images/all/1.jpg"  alt=""></a>
                                            ...
                                            <li class="clearfix">
                                                <a href="#"  class="widget-posts-img"><img src="<?php echo $html->url($theme)?>images/all/2.jpg"  alt=""></a>
                                                <div class="widget-posts-descr">
                                            ...
                                            <li class="clearfix">
                                                <a href="#"  class="widget-posts-img"><img src="<?php echo $html->url($theme)?>images/all/3.jpg"  alt=""></a>
                                                <div class="widget-posts-descr">
