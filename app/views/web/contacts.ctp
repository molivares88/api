...
<div id="wrapper">
    ...
    <div class="content">
        <section class="parallax-section" data-scrollax-parent="true">
            <div class="bg par-elem "  data-bg="<?php echo $html->url($theme)?>themes/enxona/images/bg/2.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                    ...
                    <div class="col-md-6">
                        <div class="list-single-main-item fl-wrap">
                            ...
                            <div class="list-single-main-media fl-wrap">
                                <img src="<?php echo $html->url($theme)?>themes/enxona/images/all/12.jpg" class="respimg" alt="">
                            </div>
